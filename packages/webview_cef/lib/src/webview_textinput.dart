...
mixin WebeViewTextInput implements DeltaTextInputClient {
  ...
  // Required by TextInputClient in Flutter 3.x+. webview_cef predates this
  // addition; returning false tells the framework we don't want the
  // (platform-managed) focus change to be handled by us.
  @override
