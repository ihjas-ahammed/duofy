# Node Description Batch 23 of 68
...
- "platform_io_stub_create": "create()" | kind=code-symbol | source=lib/platform/io_stub.dart:L61 | neighbors=[io_stub.dart]
- "platform_io_stub_createsync": "createSync()" | kind=code-symbol | source=lib/platform/io_stub.dart:L63 | neighbors=[io_stub.dart]
- "platform_io_stub_createtemp": "createTemp()" | kind=code-symbol | source=lib/platform/io_stub.dart:L115 | neighbors=[io_stub.dart]
- "platform_io_stub_delete": "delete()" | kind=code-symbol | source=lib/platform/io_stub.dart:L37 | neighbors=[io_stub.dart]
- "platform_io_stub_deletesync": "deleteSync()" | kind=code-symbol | source=lib/platform/io_stub.dart:L38 | neighbors=[io_stub.dart]
