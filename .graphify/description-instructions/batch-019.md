# Node Description Batch 20 of 68
...
- "ide_latex_ide_screen_setasmainfile": "_setAsMainFile()" | kind=code-symbol | source=lib/screens/ide/latex_ide_screen.dart:L707 | neighbors=[latex_ide_screen.dart]
...
- "ide_latex_ide_screen_showcompilationerrordialog": "_showCompilationErrorDialog()" | kind=code-symbol | source=lib/screens/ide/latex_ide_screen.dart:L1713 | neighbors=[latex_ide_screen.dart]
...
- "ide_latex_ide_screen_switchtofile": "_switchToFile()" | kind=code-symbol | source=lib/screens/ide/latex_ide_screen.dart:L429 | neighbors=[latex_ide_screen.dart]
...
- "lib_main_flowapp": "FlowApp" | kind=code-symbol | source=lib/main.dart:L540 | neighbors=[main.dart]
...
- "lib_main_looksnonfatal": "_looksNonFatal()" | kind=code-symbol | source=lib/main.dart:L37 | neighbors=[main.dart]
