# Node Description Batch 45 of 68
...
- "services_module_notes_html_builder_escapehtml": "_escapeHtml()" | kind=code-symbol | source=lib/services/module_notes_html_builder.dart:L691 | neighbors=[module_notes_html_builder.dart]
- "services_module_notes_html_builder_formatcontent": "_formatContent()" | kind=code-symbol | source=lib/services/module_notes_html_builder.dart:L655 | neighbors=[module_notes_html_builder.dart]
...
- "services_module_notes_service_addlistener": "addListener()" | kind=code-symbol | source=lib/services/module_notes_service.dart:L41 | neighbors=[module_notes_service.dart]
- "services_module_notes_service_and": "and" | kind=code-symbol | source=lib/services/module_notes_service.dart:L283 | neighbors=[module_notes_service.dart]
- "services_module_notes_service_as": "as" | kind=code-symbol | source=lib/services/module_notes_service.dart:L542 | neighbors=[module_notes_service.dart]
- "services_module_notes_service_buildnativepdffromnotes": "_buildNativePdfFromNotes()" | kind=code-symbol | source=lib/services/module_notes_service.dart:L951 | neighbors=[module_notes_service.dart]
- "services_module_notes_service_cleanlatexfornativepdf": "_cleanLatexForNativePdf()" | kind=code-symbol | source=lib/services/module_notes_service.dart:L886 | neighbors=[module_notes_service.dart]
- "services_module_notes_service_deletenotes": "deleteNotes()" | kind=code-symbol | source=lib/services/module_notes_service.dart:L86 | neighbors=[module_notes_service.dart]
- "services_module_notes_service_ensurelocalmathjax": "_ensureLocalMathJax()" | kind=code-symbol | source=lib/services/module_notes_service.dart:L114 | neighbors=[module_notes_service.dart]
- "services_module_notes_service_function": "Function()" | kind=code-symbol | source=lib/services/module_notes_service.dart:L26 | neighbors=[module_notes_service.dart]
- "services_module_notes_service_generatemodulenotes": "generateModuleNotes()" | kind=code-symbol | source=lib/services/module_notes_service.dart:L284 | neighbors=[module_notes_service.dart]
- "services_module_notes_service_getnoteshtmlpath": "getNotesHtmlPath()" | kind=code-symbol | source=lib/services/module_notes_service.dart:L169 | neighbors=[module_notes_service.dart]
