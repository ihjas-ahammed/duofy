# Node Description Batch 27 of 68
...
- "screens_course_edit_structure_screen_showshiftoffsetdialog": "_showShiftOffsetDialog()" | kind=code-symbol | source=lib/screens/course_edit_structure_screen.dart:L389 | neighbors=[course_edit_structure_screen.dart]
- "screens_course_edit_structure_screen_startdownload": "_startDownload()" | kind=code-symbol | source=lib/screens/course_edit_structure_screen.dart:L1610 | neighbors=[course_edit_structure_screen.dart]
- "screens_course_settings_screen_addformat": "_addFormat()" | kind=code-symbol | source=lib/screens/course_settings_screen.dart:L62 | neighbors=[course_settings_screen.dart]
- "screens_course_settings_screen_addslide": "_addSlide()" | kind=code-symbol | source=lib/screens/course_settings_screen.dart:L470 | neighbors=[course_settings_screen.dart]
- "screens_course_settings_screen_coursesettingsscreen": "CourseSettingsScreen" | kind=code-symbol | source=lib/screens/course_settings_screen.dart:L13 | neighbors=[course_settings_screen.dart]
...
- "screens_course_settings_screen_deleteformat": "_deleteFormat()" | kind=code-symbol | source=lib/screens/course_settings_screen.dart:L91 | neighbors=[course_settings_screen.dart]
- "screens_course_settings_screen_dispose": "dispose()" | kind=code-symbol | source=lib/screens/course_settings_screen.dart:L464 | neighbors=[course_settings_screen.dart]
- "screens_course_settings_screen_editslide": "_editSlide()" | kind=code-symbol | source=lib/screens/course_settings_screen.dart:L482 | neighbors=[course_settings_screen.dart]
- "screens_course_settings_screen_formateditorscreen": "FormatEditorScreen" | kind=code-symbol | source=lib/screens/course_settings_screen.dart:L441 | neighbors=[course_settings_screen.dart]
- "screens_course_settings_screen_formateditorscreenstate": "_FormatEditorScreenState" | kind=code-symbol | source=lib/screens/course_settings_screen.dart:L450 | neighbors=[course_settings_screen.dart]
...
- "screens_course_settings_screen_openeditor": "_openEditor()" | kind=code-symbol | source=lib/screens/course_settings_screen.dart:L80 | neighbors=[course_settings_screen.dart]
- "screens_course_settings_screen_resetdefaults": "_resetDefaults()" | kind=code-symbol | source=lib/screens/course_settings_screen.dart:L107 | neighbors=[course_settings_screen.dart]
- "screens_course_settings_screen_save": "_save()" | kind=code-symbol | source=lib/screens/course_settings_screen.dart:L122 | neighbors=[course_settings_screen.dart]
