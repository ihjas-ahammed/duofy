# Node Description Batch 44 of 68
...
- "services_latex_json_repairer_extractjsonstring": "extractJsonString()" | kind=code-symbol | source=lib/services/latex_json_repairer.dart:L60 | neighbors=[latex_json_repairer.dart]
- "services_latex_json_repairer_latexjsonrepairer": "LatexJsonRepairer" | kind=code-symbol | source=lib/services/latex_json_repairer.dart:L8 | neighbors=[latex_json_repairer.dart]
- "services_latex_json_repairer_removetrailingcommas": "_removeTrailingCommas()" | kind=code-symbol | source=lib/services/latex_json_repairer.dart:L230 | neighbors=[latex_json_repairer.dart]
- "services_latex_json_repairer_repair": "repair()" | kind=code-symbol | source=lib/services/latex_json_repairer.dart:L94 | neighbors=[latex_json_repairer.dart]
