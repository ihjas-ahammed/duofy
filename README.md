...
- `/lib/screens`: Home, Dashboard (Path), Lesson Player, Completion Screen, PDF Generator
- `/lib/widgets`: Modular UI components (Custom Duolingo-style Buttons, Glass Panels, MathMarkdown)
- `/lib/widgets/slide_views`: Individual renderers for theory, quiz, blanks, numericals, and JS canvas.
