...
class DatabaseService {
  ...
  Future<void> saveUserSettings({
    ...
    _userSettingsDoc.set({
      ...
      if (groqApiKeys != null) 'groqApiKeys': groqApiKeys,
      if (groqModelPrimaryTextList != null) 'groqModelPrimaryTextList': groqModelPrimaryTextList,
      if (groqModelPrimaryGraphicsList != null) 'groqModelPrimaryGraphicsList': groqModelPrimaryGraphicsList,
      if (groqModelLiteList != null) 'groqModelLiteList': groqModelLiteList,
      if (groqModelLiveList != null) 'groqModelLiveList': groqModelLiveList,
      if (cerebrasApiKeys != null) 'cerebrasApiKeys': cerebrasApiKeys,
      if (cerebrasModelPrimaryTextList != null) 'cerebrasModelPrimaryTextList': cerebrasModelPrimaryTextList,
      if (cerebrasModelPrimaryGraphicsList != null) 'cerebrasModelPrimaryGraphicsList': cerebrasModelPrimaryGraphicsList,
      if (cerebrasModelLiteList != null) 'cerebrasModelLiteList': cerebrasModelLiteList,
      if (cerebrasModelLiveList != null) 'cerebrasModelLiveList': cerebrasModelLiveList,
      if (openrouterApiKeys != null) 'openrouterApiKeys': openrouterApiKeys,
      if (openrouterModelPrimaryTextList != null) 'openrouterModelPrimaryTextList': openrouterModelPrimaryTextList,
      if (openrouterModelPrimaryGraphicsList != null) 'openrouterModelPrimaryGraphicsList': openrouterModelPrimaryGraphicsList,
      if (openrouterModelLiteList != null) 'openrouterModelLiteList': openrouterModelLiteList,
      if (openrouterModelLiveList != null) 'openrouterModelLiveList': openrouterModelLiveList,
      'updatedAt': DateTime.now().millisecondsSinceEpoch,
    }).then((_) {
